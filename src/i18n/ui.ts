...
export const ui = {
  ...
  es: {
    ...
    'footer.content': 'Contenido gestionado con Directus',
    'contact.button': "Contáctame",
    'contact.title': 'Contacta conmigo',
    'contact.subtitle': "Rellena el formulario y te responderé lo antes posible.",
    'contact.name': 'Nombre',
  ...
  en: {
    ...
    'footer.content': 'Content managed with Directus',
    'contact.button': 'Say hello!',
    'contact.title': 'Get in touch',
    'contact.subtitle': "Fill in the form and I'll get back to you as soon as possible.",
    'contact.name': 'Name',
    'contact.email': 'Email',
